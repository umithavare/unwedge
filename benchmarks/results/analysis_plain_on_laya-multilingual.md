...
|---|---|---|---|---|---|
| full | 70% | 0 (0.0%) | 63% | 0.47 | nan% |
| jev_brake | 37% | 0 (0.0%) | 42% | 0.39 | nan% |
| code_tier_only | 60% | 0 (0.0%) | 43% | 0.49 | nan% |
...
|---|---|---|---|---|
| full | 6.7% | 0.07 | 3.47 | n/a |
| jev_brake | 6.7% | 0.07 | 2.10 | n/a |
| code_tier_only | 0.0% | 0.00 | 2.50 | n/a |
| jev_only | 6.7% | 0.07 | 2.03 | n/a |

Decision rule on the untuned policies:

- full: {'catch_gain_points': 10.0, 'earlier_turns': 0.0, 'hybrid_false_alarm': 0.0, 'continue': False, 'pivot': False}
- jev_brake: {'catch_gain_points': -23.3, 'earlier_turns': -7.5, 'hybrid_false_alarm': 0.0, 'continue': False, 'pivot': False}
...
| logistic_code | 76% ± 2% | 8.7% ± 1.6% | 61% | 0.51 | 26.9 |
| logistic_code_jev | 77% ± 2% | 5.3% ± 1.6% | 68% | 0.48 | 31.7 |
...
- decision rule, logistic_code_jev vs logistic_code: {'catch_gain_points': 1.3, 'earlier_turns': 0.8, 'hybrid_false_alarm': 0.053, 'continue': False, 'pivot': False}
...
| logistic_code | 79% ± 2% | 11.3% ± 1.6% | 65% | 0.50 | 29.1 |
| logistic_code_jev | 89% ± 1% | 12.0% ± 1.6% | 82% | 0.38 | 39.2 |
...
- decision rule, logistic_code_jev vs logistic_code: {'catch_gain_points': 10.7, 'earlier_turns': 8.5, 'hybrid_false_alarm': 0.12, 'continue': False, 'pivot': False}
